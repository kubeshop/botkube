...
This is the alternative solutions to address both the configuration design issues and multichannel support. It was replaced by the [Bindings](https://github.com/infracloudio/botkube/pull/626) proposal.
