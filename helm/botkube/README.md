...
| [image.tag](./values.yaml#L20) | string | `"v1.13.0"` | Botkube container image tag. Default tag is `appVersion` from Chart.yaml. |
...
| [plugins.repositories](./values.yaml#L907) | object | `{"botkube":{"url":"https://github.com/kubeshop/botkube/releases/download/v1.13.0/plugins-index.yaml"}}` | List of plugins repositories. Each repository defines the URL and optional `headers` |
| [plugins.repositories.botkube](./values.yaml#L909) | object | `{"url":"https://github.com/kubeshop/botkube/releases/download/v1.13.0/plugins-index.yaml"}` | This repository serves officially supported Botkube plugins. |
