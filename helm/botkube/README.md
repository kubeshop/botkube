...
![Version: v0.15.0](https://img.shields.io/badge/Version-v0.15.0-informational?style=flat-square) ![AppVersion: v0.15.0](https://img.shields.io/badge/AppVersion-v0.15.0-informational?style=flat-square)
...
| [image.tag](./values.yaml#L20) | string | `"v0.15.0"` | Botkube container image tag. Default tag is `appVersion` from Chart.yaml. |
