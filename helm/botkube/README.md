...
| [image.tag](./values.yaml#L20) | string | `"v0.13.0"` | BotKube container image tag. Default tag is `appVersion` from Chart.yaml. |
...
| [e2eTest.image.tag](./values.yaml#L634) | string | `"v0.13.0"` | Test runner image tag. Default tag is `appVersion` from Chart.yaml. |
