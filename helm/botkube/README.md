...
| [plugins.repositories](./values.yaml#L908) | object | `{"botkube":{"url":"https://github.com/kubeshop/botkube/releases/download/v1.9.0/plugins-index.yaml"}}` | List of plugins repositories. Each repository defines the URL and optional `headers` |
| [plugins.repositories.botkube](./values.yaml#L910) | object | `{"url":"https://github.com/kubeshop/botkube/releases/download/v1.9.0/plugins-index.yaml"}` | This repository serves officially supported Botkube plugins. |
