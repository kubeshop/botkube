...
![Version: v1.1.0-rc.1](https://img.shields.io/badge/Version-v1.1.0--rc.1-informational?style=flat-square) ![AppVersion: v1.1.0-rc.1](https://img.shields.io/badge/AppVersion-v1.1.0--rc.1-informational?style=flat-square)
...
| [image.tag](./values.yaml#L20) | string | `"v1.1.0-rc.1"` | Botkube container image tag. Default tag is `appVersion` from Chart.yaml. |
...
| [plugins](./values.yaml#L972) | object | `{"cacheDir":"/tmp","repositories":{"botkube":{"url":"https://github.com/kubeshop/botkube/releases/download/v1.1.0-rc.1/plugins-index.yaml"}}}` | Configuration for Botkube executors and sources plugins. |
| [plugins.cacheDir](./values.yaml#L974) | string | `"/tmp"` | Directory, where downloaded plugins are cached. |
| [plugins.repositories](./values.yaml#L976) | object | `{"botkube":{"url":"https://github.com/kubeshop/botkube/releases/download/v1.1.0-rc.1/plugins-index.yaml"}}` | List of plugins repositories. |
| [plugins.repositories.botkube](./values.yaml#L978) | object | `{"url":"https://github.com/kubeshop/botkube/releases/download/v1.1.0-rc.1/plugins-index.yaml"}` | This repository serves officially supported Botkube plugins. |
