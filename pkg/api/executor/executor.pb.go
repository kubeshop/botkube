...
var file_executor_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x3a, 0x0a, 0x0a, 0x4a,
	...
	0x16, 0x0a, 0x06, 0x72, 0x65, 0x66, 0x55, 0x52, 0x4c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x06, 0x72, 0x65, 0x66, 0x55, 0x52, 0x4c, 0x22, 0x79, 0x0a, 0x0a, 0x44, 0x65, 0x70, 0x65, 0x6e,
	...
	0x38, 0x01, 0x32, 0x8e, 0x01, 0x0a, 0x08, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x6f, 0x72, 0x12,
	...
	0x65, 0x22, 0x00, 0x42, 0x12, 0x5a, 0x10, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x65,
...
var file_executor_proto_goTypes = []interface{}{
	...
	nil,                      // 6: executor.MetadataResponse.DependenciesEntry
	nil,                      // 7: executor.Dependency.UrlsEntry
...
var file_executor_proto_depIdxs = []int32{
	...
	6, // 2: executor.MetadataResponse.dependencies:type_name -> executor.MetadataResponse.DependenciesEntry
	7, // 3: executor.Dependency.urls:type_name -> executor.Dependency.UrlsEntry
	...
	8, // 6: executor.Executor.Metadata:input_type -> google.protobuf.Empty
	2, // 7: executor.Executor.Execute:output_type -> executor.ExecuteResponse
	3, // 8: executor.Executor.Metadata:output_type -> executor.MetadataResponse
