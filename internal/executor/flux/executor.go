	...
	return map[string]api.Dependency{
		...
		"gh": {
			URLs: map[string]string{
				...
				"linux/amd64":   "https://github.com/cli/cli/releases/download/v2.32.1/gh_2.32.1_linux_amd64.zip//gh_2.32.1_linux_amd64/bin",
				"linux/arm64":   "https://github.com/cli/cli/releases/download/v2.32.1/gh_2.32.1_linux_arm64.zip//gh_2.32.1_linux_arm64/bin",
			},
		},
	}
}
